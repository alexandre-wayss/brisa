...
let library: [Sound] = [
 ...
 .init(id:"realForest",name:"Forest Birds",icon:"tree",category:"Nature",detail:"Real field recording · CC0"),
 .init(id:"realRain",name:"Steady Rain",icon:"cloud.rain.fill",category:"Water",detail:"Real field recording · CC0"),
 .init(id:"realCity",name:"City Street",icon:"building.2.fill",category:"Spaces",detail:"Real field recording · CC0"),
