...
struct MenuBarPlayerView: View {
 ...
 var body: some View {
  VStack(spacing:16){
   ...
   Button("Open Desktop Player") { BrisaDesktopPlayer.shared.show() }.buttonStyle(.plain).foregroundStyle(accent)
   Button("Quit Brisa Completely") { NSApp.terminate(nil) }.buttonStyle(.plain).font(.system(size: 10)).foregroundStyle(.secondary)
