...
- **Shortcuts, Siri and Spotlight**: play a mix or sound, pause, resume, set the volume, set the sleep timer, or start and pause a focus session. A **Focus filter** plays a mix and starts a focus session when a Focus turns on (System Settings → Focus → Focus filters → Brisa) and stops them when it ends.
